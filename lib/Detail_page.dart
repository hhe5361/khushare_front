        ...
        child: Column(
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                Text(
                    "${(widget.day_percent[0] * 100).floor()}%\n${progress_text(widget.day_percent[6])}",
                    style: const TextStyle(fontSize: 35,fontWeight: FontWeight.bold)),
                const SizedBox(width: 30),
                CircularPercentIndicator(
                  percent: widget.day_percent[0],
                  progressColor: progress_bar(widget.day_percent[0]),
...
String get_month(int value) {
  ...
  if(value == 6) return "today";

  var result = now.subtract(Duration(days: 6-value));
